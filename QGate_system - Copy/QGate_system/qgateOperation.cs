    ...
    public partial class qgateOperation : Form
    {
        ...
        private async Task subStringQrProduct(string qrcodeDMC)
        {
            ...
            {/**/
                ...
                if (qrcodeDMC != null)
                {
                    if (model.ContainsThaiCharacters(qrcodeDMC))
                    {
                        MessageBox.Show("ห้ามกรอกข้อมูลภาษาไทย");
                        tbQrSerial.Clear();
                    }
                    else
                    {
                        ...
                        if (responseData.Status == 1)
                        {
                            ...
                            Console.WriteLine("qrcodeDMC: " + qrcodeDMC);
                            Console.WriteLine("responseData.mdtd_end: " + responseData.mdtd_end);
                            ...
                            {
                                //MessageBox.Show("Scanไม่ถูกต้อง กรุณาScanใหม่");
                                MessageBox.Show("no response in api");
        ...
        private async Task checkcodedmc(string PartNo, string qrcodeDMC)
        {
            ...
            if (responseData.Status == 1)
            {
                Console.WriteLine("DMC responseData : " + responseData);
                Console.WriteLine("DMC PartNo : " + PartNo);
                ...
                if (responseData.mpn_dmc_check == PartNo)
                {
                    try
                    {
                        ...
                        Console.WriteLine("dataWorkShoft" + dataWorkShoft);
                        ...
                        Console.WriteLine("responseDataWorkShoft" + responseDataWorkShoft.ToString());
                        ...
                        if (responseDataWorkShoft.Status == "1")
                        {
                            ...
                            Console.WriteLine("responseDatapartNoName" + responseDatapartNoName); //responseDatapartNoName.mdt_id
                            ...
                            Console.WriteLine("responseDataTagFA" + responseDataTagFA);
        ...
        private void lbNg_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Scan งานสิค้าบอ้วน");
            }
        }
